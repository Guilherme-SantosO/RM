...
$conexao = new mysqli($nomeservidor, $usuario, $senha, $nomeBD);
    ...
    echo "
    <form action='vizualizar_pedidos.php' method='POST'>
    <h1><span style='color:white;'>Selecione a pizza</h1></span>
    <select name='Pizza'>";
    ...
    while($linha = $resultado->fetch_assoc()){
        echo"
        <option value='",$linha['Pizza'],"'>",$linha['Pizza'],"</option>
        ";
    }

        
    echo "
    <form action='vizualizar_pedidos.php'>
    </select>
