  ...
  <div class="hero">
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        ...
        <?php
//dados vindo do ver_clientes.php
$pizza = $_POST['Pizza'];
...
if($conexao->connect_error){
    ...
    echo "<h2><span style='color:white;'>Pedidos cadastrados</h2></span>";
    
    $comando_select = "SELECT * FROM pedidos where Pizza = '$pizza'";
    
    $resultado = $conexao->query($comando_select);
